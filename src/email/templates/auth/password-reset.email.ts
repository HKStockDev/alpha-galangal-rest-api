...
const SUBJECT = 'Reset your Conviction password';
...
export function renderPasswordResetEmail(ctx: PasswordResetEmailContext): {
  ...
  const bodyHtml = `
    <p style="margin:0 0 12px 0;">You requested a password reset for your Conviction account.</p>
  ...
  const text = `You requested a password reset for your Conviction account.
...
— The Conviction team`;
  ...
  return {
    ...
    html: renderTransactionalEmailLayout({
      preheader: 'Use this link to reset your Conviction password.',
