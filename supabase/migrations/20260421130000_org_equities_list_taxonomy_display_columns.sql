-- SKE-43 follow-up: expose taxonomy labels + cycle scores on org equity list rows
-- (same horizon as p_cycle_horizon) for screener tables.
...
COMMENT ON FUNCTION public.list_organization_equities_v2(
  ...
  'SKE-43: active US equities with optional tag filter, search, and taxonomy cycle filters (6m/12m/24m). '
